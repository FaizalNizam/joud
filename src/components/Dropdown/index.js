...
class Dropdown extends PureComponent {
    static defaultProps = {
        ...
        // labelExtractor: ({ nationality } = {}, index) => nationality,
        propsExtractor: () => null,
    ...
    renderBase(props) {
        ...
        return (
            <CustomTextInput
                ...
                renderAccessory={<View style={{ justifyContent: "center" }}><Image source={this?.props?.icon ? this?.props?.icon : downArrow} style={{ resizeMode: 'contain', ...this?.props?.iconStyle }} /></View>}
            />
        )
    }
    ...
    renderRipple() {
        ...
        let style = {
            ...insets,
            height: this.itemSize() - bottom - 5,
            position: 'absolute',
            top: this.itemSize() + bottom
        }
        ...
        return (
            <View style={styles.accessory}>
                <View style={styles.triangleContainer}>
                    {/* <Image source={down} style={{ width: 30, height: 12, resizeMode: 'contain', tintColor: 'red' }} /> */}
    ...
    renderItem({ item, index }) {
        ...
        return (
            <DropdownItem index={index} {...props}  >
                <Text style={[styles.item, itemTextStyle, textStyle, commonStyle.textAlign(this.props.lang), { fontSize: 16 }]} numberOfLines={1}>
                    {title}
                </Text>
            </DropdownItem >
        )
        ...
        return (
            <View onLayout={this.onLayout} ref={this.updateContainerRef} style={containerStyle}>
                ...
                >
                    ...
                    >
                        <View
                            style={[styles.picker, pickerStyle, pickerStyleOverrides, this?.props?.dropDownPickerStyle]}
                            onStartShouldSetResponder={() => true}
                        >
                            <FlatList
